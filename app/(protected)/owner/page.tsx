      ...
      {loading ? (
        ...
        venues.length === 0 ? emptyState() : (
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <Link href="/owner/venues/create" className="inline-flex items-center gap-1.5 rounded-xl bg-[#121A2A] px-5 py-2.5 text-sm font-semibold text-white shadow transition hover:shadow-lg">Add Venue</Link>
          </div>
              ...
              <div key={venue._id} className="group overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition hover:shadow-lg">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-4 flex gap-2">
                    <Link href={`/owner/venues/create?edit=${venue._id}`} className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-blue-600 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700"><Edit size={15} />Edit</Link>
