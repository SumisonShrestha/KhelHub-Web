                ...
                <div>
                  ...
                  <div className="mt-1 flex gap-1.5">
                    ...
                    <button
                      ...
                      className="shrink-0 rounded-lg bg-[#121A2A] px-3 py-2 text-xs font-semibold text-white shadow transition hover:shadow-lg disabled:opacity-50"
                    >
                      Send OTP
                    </button>
                  </div>
                  {showOtpInput && (
                    <input
                      ...
                      maxLength={6}
                      className="mt-1.5 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  )}
                </div>
              </div>
